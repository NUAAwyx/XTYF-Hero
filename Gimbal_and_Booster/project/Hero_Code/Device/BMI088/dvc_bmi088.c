...
void BMI088_read(struct Struct_BMI088 *BMI088)
{
...
/*     BMI088_accel_read_muli_reg(BMI088_ACCEL_XOUT_L, buf, 6);
    ...
    BMI088->Roll_Acceleration = bmi088_raw_temp * BMI088_ACCEL_SEN;
    bmi088_raw_temp = (int16_t)((buf[3]) << 8) | buf[2];
    BMI088->Pitch_Acceleration = bmi088_raw_temp * BMI088_ACCEL_SEN;
    bmi088_raw_temp = (int16_t)((buf[5]) << 8) | buf[4];
    BMI088->Yaw_Acceleration = bmi088_raw_temp * BMI088_ACCEL_SEN; */
    ...
    {
        bmi088_raw_temp = (int16_t)((buf[3]) << 8) | buf[2];
        BMI088->Roll_Omega = bmi088_raw_temp * BMI088_GYRO_SEN;
        bmi088_raw_temp = (int16_t)((buf[5]) << 8) | buf[4];
        BMI088->Pitch_Omega = bmi088_raw_temp * BMI088_GYRO_SEN;
        bmi088_raw_temp = (int16_t)((buf[7]) << 8) | buf[6];
        BMI088->Yaw_Omega = bmi088_raw_temp * BMI088_GYRO_SEN;
    }

...
/* void Write_Control_Parameter(uint8_t controlParamID, uint8_t controlParamByte1, uint8_t controlParamByte2, uint8_t controlParamByte3, uint8_t controlParamByte4, uint8_t controlParamByte5, uint8_t controlParamByte6)
{
...
void Set_inputSpeedLimit(uint8_t controlParamID, int32_t max_speed)
{
    CAN1_0x141_Tx_Data[0] = 0xC1;
    CAN1_0x141_Tx_Data[1] = 0x20;
    CAN1_0x141_Tx_Data[2] = 0x00;
    CAN1_0x141_Tx_Data[3] = 0x00;
    CAN1_0x141_Tx_Data[4] = *(uint8_t *)(&max_speed);
    CAN1_0x141_Tx_Data[5] = *((uint8_t *)(&max_speed)+1);
    CAN1_0x141_Tx_Data[6] = 0x00;
    CAN1_0x141_Tx_Data[7] = 0x00;
...
void Motor_LK_Data_Process(struct Struct_CAN_Rx_Buffer *rx_buffer)
{
    ...
    //Motor_LK.Angle = Motor_LK.encoder / 65535.0 * 2 * PI;
    Motor_LK.Angle = Motor_LK.encoder / 65535.0 * 360;
    ...
    //Motor_LK.Angle = Motor_LK.Angle / 360 * 2 * PI;
    Motor_LK.Omega = Motor_LK.speed * DEG_TO_RAD;
}
...
void VOFA_to_Motor_LK(struct Struct_Motor_LK *motor_lk)
{
    switch (vofa_cmd_type)
    {
    case OP:
        PID_Set_Kp(&motor_lk->PID_Omega, vofa_cmd_data);
        break;
    case OI:
        PID_Set_Ki(&motor_lk->PID_Omega, vofa_cmd_data);
        break;
    case OD:
        PID_Set_Kd(&motor_lk->PID_Omega, vofa_cmd_data);
        break;
    case OF:
        PID_Set_Kf(&motor_lk->PID_Omega, vofa_cmd_data);
        break;
    case OT:
        PID_Set_Target(&motor_lk->PID_Omega, vofa_cmd_data);
        break;
    case AP:
        PID_Set_Kp(&motor_lk->PID_Angle, vofa_cmd_data);
        break;
    case AI:
        PID_Set_Ki(&motor_lk->PID_Angle, vofa_cmd_data);
        break;
    case AD:
        PID_Set_Kd(&motor_lk->PID_Angle, vofa_cmd_data);
        break;
    case AF:
        PID_Set_Kf(&motor_lk->PID_Angle, vofa_cmd_data);
        break;
    case AT:
        PID_Set_Target(&motor_lk->PID_Angle, vofa_cmd_data);
        break;    
    default:
        break;
    }
